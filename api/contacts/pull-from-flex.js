...
export default async function handler(req, res) {
  ...
  // Reached via: GET or POST /api/contacts/pull-from-flex?route=pos
  // Rewritten from:  GET/POST /api/pos/pull-from-flex  (vercel.json rewrite)
  // NOTE: must be checked BEFORE the GET health check below — Vercel crons use GET
