/**
 * Flex ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Monday Contact Sync (Pull Direction)
 *
 ...
 *     (use sparingly ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ will touch every contact)
 *
 * Invocation options:
 *   POST /api/contacts/pull-from-flex               ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 24h lookback
 *   POST /api/contacts/pull-from-flex?hours=1       ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ 1h lookback (15-min cron)
 *   POST /api/contacts/pull-from-flex?full=true     ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ full resync
 *   GET  /api/contacts/pull-from-flex               ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ health check
 *
 * Author: Antic Studios ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ShowFlow
 */
...
const NEW_ADDITIONS_GROUP = 'group_mm3y3xvh';  // ÃÂÃÂ°ÃÂÃÂÃÂÃÂ¤ÃÂÃÂ NEW ADDITIONS ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ top group
...
async function fetchFlexContacts(sinceISO, page = 0, size = 100) {
  ...
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¥ Fetching Flex contacts page ${page} since ${sinceISO || 'beginning of time'}`);
...
function buildMondayColumnValues(flexContact) {
  ...
  // Email ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ grab the defaultEmail or first entry
  ...
  // Phone ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ grab the defaultPhone or first entry
  ...
  // Address ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ build from first shipping address or first available
...
async function createMondayContact(flexContact) {
  ...
  console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Created Monday item: "${created?.name}" (ID: ${created?.id})`);
...
async function updateMondayContact(mondayItemId, flexContact) {
  ...
  const result = await response.json();
  if (result.errors) {
    console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Monday update failed for item ${mondayItemId}:`, result.errors);
  } else {
    console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Updated Monday item ${mondayItemId} from Flex ${flexContact.id}`);
  }
}
...
async function writeExternalNumberToFlex(flexId, mondayItemId) {
  try {
    ...
    if (response.ok) {
      console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Flex externalNumber set for ${flexId} ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday item ${mondayItemId}`);
    } else {
      console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Could not set Flex externalNumber for ${flexId}: ${response.status}`);
    }
  } catch (e) {
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Flex externalNumber write failed: ${e.message}`);
  }
}

// ================================================================
// HELPER: Process a single Flex contact ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ create or update in Monday
// ================================================================
async function processFlexContact(flexContact, seenFlexIds) {
  ...
  if (!flexId) {
    console.log('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Skipping Flex contact with no ID');
    return { action: 'skipped', reason: 'no id' };
  }

  // Skip soft-deleted contacts
  if (flexContact.deleted) {
    console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Skipping deleted Flex contact: ${flexId}`);
    return { action: 'skipped', reason: 'deleted' };
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Pagination dedup guard ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  ...
  // reappear on a later page in the same run ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ exactly how duplicates are born.
  // The seenFlexIds Set prevents processing the same UUID twice per run.
  if (seenFlexIds && seenFlexIds.has(flexId)) {
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ­ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  Already processed ${flexId} this run ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ skipping (pagination dedup)`);
    return { action: 'skipped', reason: 'pagination-dedup' };
  }
  if (seenFlexIds) seenFlexIds.add(flexId);

  console.log(`\nÃÂÃÂ¢ÃÂÃÂÃÂÃÂ¶ Processing: "${name}" (Flex: ${flexId})`);

  // 1. Check if we have a Monday item already linked to this Flex UUID
  let mondayItem = await findMondayItemByFlexId(flexId);

  if (mondayItem) {
    // Known contact ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ update
    console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Existing Monday item found: ${mondayItem.id} ("${mondayItem.name}")`);
  ...
  //    yet when step 1 ran ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ the monday item ID was already stored in Flex.
  //    (Previous version incorrectly called findMondayItemByFlexId again ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ same as step 1.)
  if (flexContact.externalNumber && /^\d{6,}$/.test(String(flexContact.externalNumber).trim())) {
    ...
    console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Matched via Flex externalNumber (monday ID: ${mondayItemId})`);
  ...
  if (name) {
    ...
    if (byName) {
      console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Matched by name: ${byName.id} ("${byName.name}") ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ linking and updating`);
  ...
  // 4. Genuinely new ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ fetch full details and create in Monday
  console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ No match found ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ creating new Monday contact`);
  const fullContact = await fetchFlexContactFull(flexId) || flexContact;
...
// ================================================================
// ============================================================================
// PO SYNC ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex Rental POs (RPO-) and Purchase POs (PPO-) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday.com
// Route: POST /api/contacts/pull-from-flex?route=pos
// URL alias: POST /api/pos/pull-from-flex  (via vercel.json rewrite)
// ============================================================================

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Board / Group IDs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Rental PO Column IDs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
const RPO_COL = {
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Purchase PO Column IDs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
const PPO_COL = {
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Projects board UUID columns (used for parentId-based project lookup) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex status name ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday status label ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
// GET /api/financial-document/{documentId}/document-total ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ plain number
async function _fetchFlexPOTotal(documentId) {
  try {
    ...
    if (!res.ok) {
      console.warn(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  Could not fetch total for ${documentId}: HTTP ${res.status}`);
      return null;
    }
    const val = await res.json();
    return typeof val === 'number' ? val : null;
  } catch (e) {
    console.warn(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  Total fetch error for ${documentId}:`, e.message);
    return null;
  }
}

// Caches to avoid repeated monday lookups within a single sync run
const _poProjectUUIDCache = {};  // parentId (UUID) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday item id
const _poProjectNameCache = {};  // parsed project name ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday item id
const _poVendorCache      = {};

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Primary: match by parentId UUID against Projects board UUID columns ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
async function _findProjectByParentUUID(parentId) {
  ...
  for (const colId of [PROJ_QUOTE_UUID_COL, PROJ_EQUIP_UUID_COL]) {
    ...
    if (match) {
      console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Project via UUID (${colId === PROJ_QUOTE_UUID_COL ? 'Quote' : 'Pullsheet'}): "${match.name}"`);
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Fallback: match by parsed name when UUID lookup finds nothing ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
// Name convention: "{Vendor abbrev} - {Project Name}"
// e.g. "Legacy - Nocturnal Valley 2026" ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ search for "Nocturnal Valley 2026"
async function _findProjectByNameFallback(poName) {
  ...
  if (match) console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Project via name: "${parsedName}" ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "${match.name}"`);
  else       console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  Project not found: parentId has no UUID match, name parse failed for "${parsedName}"`);
...
async function _findVendorByName(vendorName) {
  ...
  if (match) console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Vendor: "${vendorName}" ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "${match.name}"`);
  else       console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  Vendor not found: "${vendorName}"`);
...
async function _fetchAllFlexPOs() {
  ...
  while (true) {
    ...
    all.push(...content);
    console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Flex POs page ${page}: ${content.length} records (total pages: ${data.totalPages ?? '?'})`);
...
async function _buildRPOCols(po, today) {
  ...
  // Project: UUID-first (parentId ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Quote or Pullsheet UUID in Projects board),
...
async function _processPO(po, today, dryRun, stats) {
  ...
  console.log(`\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ ${docNum} ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "${po.name}"`);
  ...
  if (existing) {
    ...
    `);
    console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Updated ${existing.id}`);
    stats.updated++;
  } else {
    if (!dryRun) await mondayQueryPO(`
      mutation {
    ...
    `);
    console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Created in ${group}`);
    stats.created++;
  }
}
...
async function handlePOSync(req, res) {
  ...
  console.log(`\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ PO sync started${dryRun ? ' (DRY RUN)' : ''} ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ${today}`);
  ...
  try {
    ...
    console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ ${allPOs.length} POs: ${rpos.length} RPOs, ${ppos.length} PPOs`);

    for (let i = 0; i < allPOs.length; i += 5) {
      await Promise.all(
        allPOs.slice(i, i + 5).map(po =>
          _processPO(po, today, dryRun, stats).catch(err => {
            console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ${po.documentNumber}:`, err.message);
    ...
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PO sync done ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ created: ${stats.created}, updated: ${stats.updated}, errors: ${stats.errors}`);
    ...
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PO sync fatal:', err);
...
// GET  ?route=geocode  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ dry run (shows what would be geocoded)
// POST ?route=geocode  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ live run (writes to Monday location column)
...
const GEOCODE_CONCURRENCY = 5; // keep low ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ parallel geocode requests share a single API key quota
...
async function geocodeAddress(rawAddress) {
  ...
  if (data.status !== 'OK' || !data.results?.length) {
    throw new Error('Geocode status: ' + data.status + (data.error_message ? ' ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ' + data.error_message : ''));
  }
...
async function handleGeocodeRoute(req, res) {
  ...
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ geocode-new | mode: ' + (dryRun ? 'DRY RUN' : 'LIVE'));
  ...
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ ${allItems.length} in group | ${toGeocode.length} to geocode | ${alreadyDone} already have location`);
  ...
  for (let i = 0; i < toGeocode.length; i += GEOCODE_CONCURRENCY) {
    ...
    const settled = await Promise.allSettled(chunk.map(async item => {
      ...
      try {
        ...
        console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "${item.name}" ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ${loc.lat},${loc.lng} (${loc.address})`);
        return { name: item.name, itemId: item.id, status: 'geocoded',
          location: { lat: loc.lat, lng: loc.lng, address: loc.address } };
      } catch (err) {
        console.warn(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  "${item.name}": ${err.message}`);
...
// GET  ?route=dedup-group ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ dry run (shows what would be deleted)
// POST ?route=dedup-group ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ live run (deletes duplicates)
//
...
async function handleDedupGroupRoute(req, res) {
  const dryRun = req.method === 'GET';
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ dedup-group | mode: ' + (dryRun ? 'DRY RUN' : 'LIVE'));

  // Fetch all items in group with all column values
  const allItems = await getAllNewAdditionsItems();
  console.log('Total items in group:', allItems.length);

  // Group by normalized name ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ skip generic names
  const groups = {};
  const skipped = [];
  ...
  // Live ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ delete in batches of 10
  const results = [];
  for (let i = 0; i < toDelete.length; i += 10) {
    const chunk = toDelete.slice(i, i + 10);
    const settled = await Promise.allSettled(chunk.map(async item => {
      await deleteMondayItem(item.itemId);
      console.log('  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ  deleted', item.name, item.itemId);
...
// GET  ?route=sort-new ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ dry run (shows proposed classification)
// POST ?route=sort-new ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ live (sets Company Type + moves to group)
//
// Skips items that already have Company Type set (idempotent).
// Classification priority:
//   1. Keyword patterns in name
//   2. Flex Contact Type (Client ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Artist, Venue ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Venue)
//   3. Fallback ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Other Services & Vendors
// ================================================================
...
// Company Type ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Group mapping
const TYPE_TO_GROUP = {
...
function classifyContact(name, flexContactType) {
  ...
  // If Flex says Client ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ likely artist / performer
...
async function handleSortNewRoute(req, res) {
  const dryRun = req.method === 'GET';
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ sort-new | mode: ' + (dryRun ? 'DRY RUN' : 'LIVE'));
  ...
  // Live ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ process in batches of 5
  const results = [];
  for (let i = 0; i < plan.length; i += 5) {
    ...
    const settled = await Promise.allSettled(chunk.map(async p => {
      ...
      console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ "${p.name}" ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ${p.typeName} / ${p.groupName}`);
...
// ================================================================
// BATCH HELPER ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ fires chunks in parallel via Promise.all
...
// ================================================================
// Pre-fetch ALL existing parent items ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ { flexUnitId: mondayItemId }
// ================================================================
...
// ================================================================
// Pre-fetch ALL existing subitems ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ { flexOocId: mondaySubitemId }
// ================================================================
...
// ================================================================
// ROUTE: sync-ooc ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ batched mutations, no serial unit fetches
// ================================================================
async function handleSyncOocRoute(req, res) {
  const startedAt = Date.now();
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ§ sync-ooc starting (batched)');
  ...
  while (keepGoing) {
    ...
    console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Flex OOC page ${page}: ${recs.length} records`);
    if (data.last || recs.length < 100) keepGoing = false;
    else if (++page >= 50) keepGoing = false;
  }
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Total OOC records: ${allOocRecords.length}`);

  // 2. Group by serialUnitId ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ skip non-serialized items
  const byUnit = {};
  ...
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ© Unique serialized units: ${unitIds.length}`);

  // 3. Bulk pre-fetch existing monday items & subitems in parallel
  console.log('ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ Pre-fetching existing monday data...');
  const [parentMap, subMap] = await Promise.all([buildParentItemsMap(), buildSubitemsMap()]);
  console.log(`  ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Parents: ${Object.keys(parentMap).length} | Subitems: ${Object.keys(subMap).length}`);

  // Fetch Flex unit statuses to catch Decommissioned / Missing (not in OOC records)
  console.log('ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Fetching Flex unit statuses...');
  ...
  for (const unitId of unitIds) {
    ...
    const itemName = JSON.stringify(`${sample.modelName || ''} ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SN:${serial}`);
  ...
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ Parent creates: ${parentCreates.length} | updates: ${parentUpdates.length}`);
  ...
  console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Parents done. Created: ${createResults.filter(r=>r?.id).length} | Updated: ${updateResults.length}`);
  ...
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¨ Subitem creates: ${subCreates.length} | updates: ${subUpdates.length}`);
  ...
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ sync-ooc complete:', summary);
  return res.status(200).json(summary);
}

// ================================================================
// ROUTE: resolve-ooc ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ push resolution from monday back to Flex
// ================================================================
async function handleResolveOocRoute(req, res) {
  console.log('\nÃÂÃÂ¢ÃÂÃÂÃÂÃÂ resolve-ooc triggered');
  ...
  if (!subitemId) return res.status(400).json({ error: 'Missing subitemId ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ send body.subitemId, body.itemId, or body.event.pulseId' });

  try {
    // Read flexOocId, reportedDate, AND resolvedDate ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ resolvedDate used as de-dupe guard
    ...
    // De-dupe: if already resolved (resolvedDate stamped), skip ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prevents automation loop
    ...
    if (!flexRes.ok) {
      ...
      console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex resolve failed ${flexOocId}: ${flexRes.status} ${errText}`);
      return res.status(502).json({ error: `Flex rejected resolve for OOC ID ${flexOocId}`, status: flexRes.status });
    }
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex OOC ${flexOocId} resolved`);

    // Write back to monday: set Repair Status ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Resolved, stamp resolvedDate and daysDown
    const today    = new Date().toISOString().split('T')[0];
    ...
    if (mondayWriteData.errors) {
      console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday write-back failed:', JSON.stringify(mondayWriteData.errors));
    ...
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ resolve-ooc error:', err);
...
// ================================================================
// ROUTE: mark-missing ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ flag a unit as presumed missing in Flex + monday
// Body: { itemId } (parent item ID on the Repair Tracker board)
// ================================================================
async function handleMarkMissingRoute(req, res) {
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ mark-missing triggered');
  const body = typeof req.body === 'string' ? JSON.parse(req.body) : req.body || {};
  if (body.challenge) return res.status(200).json({ challenge: body.challenge });

  const itemId = body.event?.pulseId || body.itemId;
  if (!itemId) return res.status(400).json({ error: 'Missing itemId ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ send body.itemId or body.event.pulseId' });
  ...
  try {
    ...
    if (!flexRes.ok) {
      const errText = await flexRes.text().catch(() => '');
      console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex mark-missing failed ${flexUnitId}: ${flexRes.status} ${errText}`);
      return res.status(502).json({ error:`Flex rejected mark-missing for unit ${flexUnitId}`, status:flexRes.status });
    }
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex unit ${flexUnitId} marked presumedMissing`);

    // Write back to monday: set Current Status ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Missing, stamp missingSince date
    const today = new Date().toISOString().split('T')[0];
    const updateCv = JSON.stringify({
    ...
    if (writeData.errors) {
      console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ monday write-back failed:', JSON.stringify(writeData.errors));
    ...
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ mark-missing error:', err);
    return res.status(500).json({ error: err.message });
  }
}

// ================================================================
// ROUTE: decommission ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ permanently retire a unit in Flex + monday
// Body: { itemId } (parent item ID on the Repair Tracker board)
// ================================================================
async function handleDecommissionRoute(req, res) {
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂªÃÂÃÂ¦ decommission triggered');
  const body = typeof req.body === 'string' ? JSON.parse(req.body) : req.body || {};
  if (body.challenge) return res.status(200).json({ challenge: body.challenge });
  ...
  try {
    ...
    if (!flexRes.ok) {
      const errText = await flexRes.text().catch(() => '');
      console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex decommission failed ${flexUnitId}: ${flexRes.status} ${errText}`);
      return res.status(502).json({ error:`Flex rejected decommission for unit ${flexUnitId}`, status:flexRes.status });
    }
    console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex unit ${flexUnitId} decommissioned`);

    // Write back to monday: set Current Status ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Decommissioned, stamp date + user
    const updateCv = JSON.stringify({
    ...
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ decommission error:', err);
    return res.status(500).json({ error: err.message });
  }
}
...
export default async function handler(req, res) {
  ...
  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ GEOCODE ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'geocode') {
    try { return await handleGeocodeRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ geocode error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DEDUP GROUP ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'dedup-group') {
    try { return await handleDedupGroupRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ dedup-group error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SYNC-OOC ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'sync-ooc') {
    try { return await handleSyncOocRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ sync-ooc error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ RESOLVE-OOC ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'resolve-ooc') {
    try { return await handleResolveOocRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ resolve-ooc error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ MARK-MISSING ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'mark-missing') {
    try { return await handleMarkMissingRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ mark-missing error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ DECOMMISSION ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'decommission') {
    try { return await handleDecommissionRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ decommission error:', err); return res.status(500).json({ error: err.message }); }
  }

  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ SORT-NEW ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  if (req.query && req.query.route === 'sort-new') {
    try { return await handleSortNewRoute(req, res); }
    catch (err) { console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ sort-new error:', err); return res.status(500).json({ error: err.message }); }
  }


  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PO sync sub-route ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  ...
  // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ PUSH-TO-FLEX ROUTE ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
  ...
  console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ pull-from-flex starting');
  const startedAt = Date.now();
  ...
  try {
    ...
    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Determine lookback window ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    ...
    console.log(fullSync
      ? `ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Full sync mode ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ all Flex contacts`
      : `ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ±ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Lookback: ${hoursBack}h (since ${sinceISO})`
    );

    // ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Paginate through Flex contacts ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
    const results = { created: 0, updated: 0, linked: 0, skipped: 0, errors: 0, details: [] };
    const seenFlexIds = new Set(); // Track processed UUIDs ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ prevents pagination-driven duplicates
    let page = 0;
    let keepGoing = true;
    ...
    while (keepGoing) {
      ...
      console.log(`  ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Page ${page}: ${rawCount} raw, ${contacts.length} in window`);
      ...
      for (const contact of contacts) {
        try {
          ...
          console.error(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Error processing Flex contact ${contact.id}:`, e.message);
          results.errors++;
      ...
      if (rawCount < 100) {
        ...
        if (page >= 20) {
          console.log('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ Page cap reached ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ stopping. Run again or use ?full=true for more.');
          keepGoing = false;
        }
      }
    }
    ...
    console.log('\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ pull-from-flex complete:', summary);
    return res.status(200).json(summary);

  } catch (err) {
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ pull-from-flex fatal error:', err);
    return res.status(500).json({ error: err.message });
  }
}

// =============================================================================
// PUSH-TO-FLEX ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ merged from api/contacts/push-to-flex.js
// Handles monday.com ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex contact sync (create/update direction).
// Invoked via: POST /api/contacts/pull-from-flex?route=push
// Rewritten from: POST /api/contacts/push-to-flex  (vercel.json rewrite)
// =============================================================================

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ MAIN PUSH HANDLER ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
async function handlePushToFlex(req, res) {
  ...
  if (req.method === 'GET' && req.query?.bulk === 'true') {
    ...
    console.log(`\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¦ Bulk push-to-flex | cursor: ${cursor || 'start'} | batchSize: ${batchSize}`);
    try {
      const { items, nextCursor } = await ptfGetMondayItemsWithoutFlexId(cursor, batchSize);
      console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ Found ${items.length} contacts without Flex UUID`);
  ...
  console.log(`\nÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ push-to-flex | event: ${event.type} | item: ${itemId}`);
  ...
  try {
    ...
    console.error('ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ push-to-flex error:', err);
    return res.status(500).json({ error: err.message });
  }
}

// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Address helpers ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
async function ptfUpdateFlexAddress(flexContactId, addressId, addrPayload) {
  ...
  if (!res.ok) console.warn(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ updateFlexAddress HTTP ${res.status}`);
}
...
async function ptfCreateFlexAddress(flexContactId, addrPayload) {
  ...
  if (!res.ok) console.warn(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ ÃÂÃÂ¯ÃÂÃÂ¸ÃÂÃÂ createFlexAddress HTTP ${res.status}`);
}
...
// ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Monday helpers (push direction) ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ
...
async function ptfWriteFlexIdToMonday(itemId, flexUUID) {
  ...
  console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex Contact ID written to Monday item ${itemId}: ${flexUUID}`);
}
...
async function ptfCreateFlexContact(payload) {
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¤ Creating Flex contact: "${payload.name}"`);
  ...
  console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex contact created: ${flexId}`);
  return flexId;
}

async function ptfUpdateFlexContact(flexUUID, payload) {
  console.log(`ÃÂÃÂ°ÃÂÃÂÃÂÃÂÃÂÃÂ¤ Updating Flex contact: ${flexUUID} ("${payload.name}")`);
  ...
  console.log(`ÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Flex contact updated: ${flexUUID}`);
}
